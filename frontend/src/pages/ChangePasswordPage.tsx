    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #FFF5EE 0%, #FFEDD8 40%, #FFE4CC 100%)' }}>
      ...
      <div className="relative w-full max-w-md mx-4 animate-fade-in">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-800 tracking-tight">账户安全</h1>
          <p className="text-gray-500 text-sm mt-1">定期更换密码，保护账户安全</p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex gap-3 mt-1">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="flex-[2] py-3 rounded-xl font-medium text-sm text-white shadow-lg shadow-[#C19A83]/25 hover:shadow-xl hover:shadow-[#C19A83]/30 active:scale-[0.98] transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
